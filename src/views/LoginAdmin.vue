<template>
  <div class="container1">
    ...
    <div class="containerLogin">
      ...
      <v-btn @click="login()" outlined elevation="0" class="white--text loginBtn">Entrar</v-btn>
      <br />
      <div class="white--text mb-2">
        Não tem uma conta?
        <v-btn outlined elevation="0" class="white--text cadastro" to="/signup">Cadastre-se aqui.</v-btn>
      </div>
    </div>
  </div>
</template>
